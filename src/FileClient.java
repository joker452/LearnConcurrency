    ...
    public static void main(String[] args) {
      ...
      /* Check that the number of command-line arguments is legal.
        ...
        if (args.length == 0 || args.length > 3) {
            System.err.println("Usage:  java FileClient <server>");
            System.err.println("    or  java FileClient <server> <file>");
            System.err.println(
      ...
      /* Make the connection and open streams for communication.
        ...
        try {
            ...
            System.err.println("Can't make connection to server at \"" + args[0] + "\".");
